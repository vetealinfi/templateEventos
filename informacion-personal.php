                                ...
                                <div class="panel-group" role="tablist">
									...
									<div class="panel panel-default">
										...
										<div id="collapseListGroup1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading1" aria-expanded="true">
											<ul class="list-group submenu">
												<a href="proximos-eventos.php"><li class="list-group-item">Próximos eventos</li></a>
									...
									<div class="panel panel-default">
										...
										<div id="collapseListGroup2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="collapseListGroupHeading1" aria-expanded="true">
											<ul class="list-group submenu">
												<a href="informacion-personal.php"><li class="list-group-item active">Información personal</li></a>
